...
public class DoubleXLabelAxisRenderer2 extends XAxisRenderer {

    private IAxisValueFormatter topValueFormatter;

    public DoubleXLabelAxisRenderer2(ViewPortHandler viewPortHandler, XAxis xAxis, Transformer transformer, IAxisValueFormatter topValueFormatter) {
...
//                Utils.drawXAxisValue(c, line[0], x, 1, mAxisLabelPaint, anchor, 0);
//                Utils.drawXAxisValue(c, line[1], x + mAxisLabelPaint.getTextSize(), 1 + mAxisLabelPaint.getTextSize(), mAxisLabelPaint, anchor, 0);
    ...
    protected void drawLabel(Canvas c, String formattedLabel, float x, float y, MPPointF anchor, float angleDegrees) {
        ...
        for (int i = 0; i < lines.length; i++) {
            ...
            Utils.drawXAxisValue(c, lines[i], x, y + vOffset-20, mAxisLabelPaint, anchor, angleDegrees);
        }
    }
...
//    }
    ...
    private void drawLabelsTop(Canvas c, String formattedLabel, float x, float y, MPPointF anchor, float angleDegrees) {
//        String lines[] = formattedLabel.split("\n");
//        for (int i = 0; i < lines.length; i++) {
//            float vOffset = i * mAxisLabelPaint.getTextSize();
//            Utils.drawXAxisValue(c, lines[i], x, y + vOffset, mAxisLabelPaint, anchor, 0);
//    }
