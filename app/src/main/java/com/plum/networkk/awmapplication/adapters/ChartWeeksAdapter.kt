...
import com.plum.networkk.awmapplication.activities.HoursAwayActivity
...
class ChartWeeksAdapter(context: Context) :
    ...
    var mActivityContext: HoursAwayActivity? = null

    constructor(
        mActivityContext: HoursAwayActivity,
...
//    var onGridItemClick: GridItemClick? = null
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        ViewHolderM.tvItemValue.text = dataList!!.get(position).startDate.toString()
