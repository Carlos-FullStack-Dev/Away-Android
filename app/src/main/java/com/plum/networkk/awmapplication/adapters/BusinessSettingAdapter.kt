...
class BusinessSettingAdapter(context: Context) :
    RecyclerView.Adapter<RecyclerView.ViewHolder>() {

    var dataList: ArrayList<BusinessSettingDataModel>? = null

    constructor(mContext: Context, breakDataList: ArrayList<BusinessSettingDataModel>) : this(mContext) {
...
//    var onGridItemClick: GridItemClick? = null
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val v = LayoutInflater.from(parent.context).inflate(
            R.layout.item_list_business_setting,
            parent, false
        )
    ...
    fun setDataToList(mList: ArrayList<BusinessSettingDataModel>) {
        this.dataList = mList
